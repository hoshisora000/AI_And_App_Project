...
if ($result = mysqli_query($link, "SELECT * FROM member")) {
      while ($row = mysqli_fetch_assoc($result)) {
          ...
          $a['data'][] = array($row["uid"],$row["nickname"], $row["mobile_barcode"],"<button class='m_btn_delete btn btn-danger btn-xs' id='m_btn_delete'><i class='glyphicon glyphicon-pencil'></i>刪除</button>");
    }
